...
public class ChoreHouseChoresRecyclerViewAdapter extends RecyclerView.Adapter<ChoreHouseChoresRecyclerViewAdapter.ViewHolder> {
    private List<Chore> choresList;
    private Context context;

    public ChoreHouseChoresRecyclerViewAdapter(List<Chore> choresList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.chores_housechores_row, parent, false);
